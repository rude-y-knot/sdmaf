  ...
  slides: {
    ...
    nomenclature: [
      ...
      },
      {
        ...
        description: 'Прямые цельносварные тоннельные скаты диаметром до 790 мм с идеальной зеркальной полировкой внутренней поверхности и безопасным плавным торможением.',
        specs: 'Диаметр до 790 мм, пищевая сталь AISI 304, герметичная фланцевая сборка'
      },
      {
