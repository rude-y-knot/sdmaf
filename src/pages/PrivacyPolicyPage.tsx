      ...
      content: (
        <div className="space-y-3 text-xs sm:text-sm text-neutral-700 leading-relaxed font-light">
          ...
          <ul className="list-disc pl-5 space-y-1.5">
            ...
            <li>
              <strong>Заключение и исполнение договоров:</strong> оформление договоров поставки, спецификаций, отгрузочных документов (УПД, ТОРГ-12, ТТН), паспортов качества и сертификатов на материалы;
            </li>
            <li>
