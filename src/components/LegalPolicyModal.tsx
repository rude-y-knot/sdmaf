          ...
          {type === 'offer' && (
            <div className="space-y-6">
              ...
              <div>
                ...
                <p>
                  Точная стоимость металлоконструкций, лазерного раскроя и малых архитектурных форм фиксируется в официальной Спецификации к Договору поставки. Оплата производится в безналичном порядке с НДС 22% по выставленному счету.
                </p>
              </div>
