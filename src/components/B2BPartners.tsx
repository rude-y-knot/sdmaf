  ...
  const audiences = [
    {
      ...
      desc: 'Комплексное благоустройство закрытых дворовых территорий ЖК комфорт- и бизнес-класса. Сдача Госкомиссии, паспорта качества и сертификаты на материалы, гарантия 2 года.',
    ...
    },
    {
      ...
      desc: 'Изготовление специфических элементов из нержавеющей стали: приставные и переходные лестницы, поручни, площадки обслуживания, трапы и технологические ограждения.',
      tags: ['AISI 304 / 316', 'TIG сварка', 'Пассивация', 'Лестницы и поручни'],
    },
  ];
